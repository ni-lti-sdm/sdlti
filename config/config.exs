...
config :kafka_ex,
  ...
  #
  # First attempt: did not work on local machine while VPNed into NI
  # brokers: [
  #   {"kafka-cluster-kafka-bootstrap.strimzi.svc.cluster.local", 9094}
  # ],
  #
  # This is the EXTERNAL-IP of service/kafka-cluster-kafka-external-bootstrap LoadBalancer
  brokers: [
    {"34.69.58.165", 9094}
  ],
  # This is also, but currently getting nxdomain error trying to use it
  # brokers: [
  #   {"kafka-cluster-kafka-external-bootstrap.strimzi.svc.cluster.local", 9094}
  # ],
  #
  # OR:
